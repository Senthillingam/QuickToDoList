...
$(function () {
	...
	/**
	* Sets defaults & performs data validation on new model initialization.
	*/
	...
	*/
	...
	/**
	* For ensuring old views are destroyed before rendering a new view
	*/
	...
	/**
	* For rendering each checklist item and handling event logic
	*/
	...
	/**
	* For rendering settings view and handling event logic
	*/
	...
	/**
	* For rendering edit view and handling event logic
	*/
	EditView = Backbone.View.extend({
		...
		updateShareLink: function () {
			...
			mail += 'subject=' + encodeURIComponent(subject);
			mail += '&body=' + '/#add/' + encodeURIComponent(item.replace(/\ /g, '+'));
	...
	/**
	* For rendering main list view and handling event logic
	*/
	ListView = Backbone.View.extend({
		...
		render: function () {
			...
			document.title = 'QuickToDoList (' + this.collection.remaining().length + ')';
			return this;
		},
